...
export const LEVELS: LevelDef[] = [
  swap({
    ...
    act: 1,
    title: "Гараж Artwave",
    blurb: "Свайпни соседа, собери три в ряд",
    moves: 30,
    size: 8,
    colors: A,
    goals: [
  ...
  }),
  {
    ...
    kind: "ride",
    title: "На велике",
    blurb: "Собери кабель, объезжай ямы",
    moves: 0,
    size: 0,
    colors: A,
  ...
  }),
  {
    ...
    kind: "ride",
    title: "Дождь пошёл",
    blurb: "Мокрый асфальт, тот же кабель",
    moves: 0,
    size: 0,
    colors: A,
...
> = {
  ...
  ride: { label: "Велик", accent: "#6FE04B" },
